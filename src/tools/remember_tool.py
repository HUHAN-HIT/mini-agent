...
class RememberTool(BaseTool):
    ...
    description = (
        ...
        "save: store user preferences, insights, or context. "
    ...
    parameters = {
        "type": "object",
        "properties": {
            "action": {"type": "string", "enum": ["save", "recall", "forget"], "description": "save | recall | forget"},
            "title": {"type": "string", "description": "Memory title (for save/forget)"},
            "content": {"type": "string", "description": "Memory content (for save)"},
            "memory_type": {"type": "string", "enum": ["user", "feedback", "project", "reference"], "description": "Memory category (default: project)"},
