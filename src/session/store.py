...
class SessionStore:
    ...
    def get_session(self, session_id: str) -> Optional[Session]:
        data = self._read_json(self._session_file(session_id))
    ...
    def create_attempt(self, attempt: Attempt) -> Attempt:
        ...
        self._write_json(self._attempt_file(attempt.session_id, attempt.attempt_id), attempt.to_dict())
        return attempt

    def get_attempt(self, session_id: str, attempt_id: str) -> Optional[Attempt]:
        data = self._read_json(self._attempt_file(session_id, attempt_id))
        return Attempt.from_dict(data) if data else None
